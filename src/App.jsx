  ...
  <section id="top" className="hero">
    ...
    <div className="hero-content">
      <div className="hero-copy">
        ...
        <p className="lead">
          Александр настроит приложение на Samsung, LG, Sony, Android TV или TV Box. Более
          2000 каналов, спорт, фильмы, медиатека и архив передач. Оплата после установки.
        </p>
